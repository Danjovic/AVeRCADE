 ...
 * the implications!
 */
#define  USB_CFG_DEVICE_ID       0xdc, 0x27 /* = 0x27dc = Joystick */
 ...
 */
#define USB_CFG_VENDOR_NAME     'd', 'a', 'n', 'j', 'o', 'v', 'i', 'c', '@', 'h', 'o', 't', 'm', 'a', 'i', 'l', '.', 'c', 'o', 'm',
 ...
 * details.
 */
#define USB_CFG_DEVICE_NAME     'A', 'V', 'e', 'R', 'C', 'A', 'D', 'E', 
