...
/* Example configuration: Port B bit 2 is connected to a jumper which ties
...
{
  //  PORT_JP = 0;                      /* undo bootLoaderInit() changes */
}

#define bootLoaderCondition()  (1) // ((PIN_JP & (1 << JUMPER_BIT)) == 0)
